...
def create_ref_model(
    model_args: "ModelArguments", data_args: "DataArguments", finetuning_args: "FinetuningArguments", add_valuehead: bool = False
    ...
    if finetuning_args.ref_model is not None:
        ...
        ref_model = load_model(
            tokenizer, ref_model_args, data_args, ref_finetuning_args, is_trainable=False, add_valuehead=add_valuehead
        )
